...
- **Display face**: Anek Devanagari added (`--font-anek`, weights 500–700) for the wordmark, H1/H2 and large row headings. Hind stays for body/UI, JetBrains Mono for identifiers. `src/lib/fonts.ts`.
